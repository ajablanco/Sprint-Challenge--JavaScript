...
for (i = 0; i < graduates.length; i++)  {
  ...
  contactInfo.sort(); //may not need this
}
...
const animalFirstName = zooAnimals.map(element => element.animal_name.toLowerCase());
console.log(animalFirstName);
...
let pop = zooAnimals.reduce((acc, value) => {
